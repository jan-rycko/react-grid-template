export declare enum TemplateDirection {
    Row = "row",
    Column = "column"
}
export declare enum TemplateGutter {
    Margin = "margin",
    Padding = "padding"
}
export declare enum GridUnit {
    Fr = "fr",
    Px = "px",
    Rem = "rem",
    Vh = "vh",
...
export declare type GritConstantUnit = Exclude<GridUnit, GridUnit.Fr>;
export declare const gridUnits: any[];
export declare const gridUnitRegExpPart: string;
...
export declare type IGridSizeWithMargin = IGridSize & IGridMargin;
